...
func (x *MetaStatus) GetCode() int32 {
	if x != nil {
		return x.Code
	}
	return 0
...
func (x *MetaStatus) GetStatus() int32 {
	if x != nil {
		return x.Status
	}
	return 0
...
func (x *MetaStatus) GetReason() string {
	if x != nil {
		return x.Reason
	}
	return ""
...
func (x *MetaStatus) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *MetaStatus) GetMetadata() map[string]string {
	if x != nil {
		return x.Metadata
	}
	return nil
...
var file_metaerror_status_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x72, 0x22, 0xe8, 0x01, 0x0a, 0x0a, 0x4d, 0x65, 0x74, 0x61, 0x53, 0x74, 0x61, 0x74,
	...
	0x28, 0x0b, 0x32, 0x23, 0x2e, 0x6d, 0x65, 0x74, 0x61, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x2e, 0x4d,
	0x65, 0x74, 0x61, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	...
	0x5a, 0x0a, 0x2f, 0x6d, 0x65, 0x74, 0x61, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x62, 0x06, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x33,
}
...
var file_metaerror_status_proto_goTypes = []interface{}{
	(*MetaStatus)(nil), // 0: metaerror.MetaStatus
	nil,                // 1: metaerror.MetaStatus.MetadataEntry
}
var file_metaerror_status_proto_depIdxs = []int32{
	1, // 0: metaerror.MetaStatus.metadata:type_name -> metaerror.MetaStatus.MetadataEntry
